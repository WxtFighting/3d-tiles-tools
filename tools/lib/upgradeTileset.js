    ...
    return readFile(file, 'binary')
        .then(function(buffer) {
            ...
            if (magic === 'b3dm') {
                ...
                // return optimizeGlb(b3dm.glb)
                //     .then(function(glb) {
                        return glbToB3dm(b3dm.glb, b3dm.featureTable.json, b3dm.featureTable.binary, b3dm.batchTable.json, b3dm.batchTable.binary);
                    // });
            } else {
                // TODO: handle other tile formats
